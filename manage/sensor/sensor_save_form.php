...
<form action="sensor_save.php" method="post" name="form1" id="form1">
  <table  border="1" align="center">
    <tbody>
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#F86C6E" style="color: #F4F4F4; font-style: oblique; font-weight: bold;">Add New Sensor</td>
      </tr>
      <tr>
        <td>Sensor ID</td>
      ...
      <tr>
        <td colspan="2" align="center"><input type="submit" name="button" id="button" value="Add sensor">
